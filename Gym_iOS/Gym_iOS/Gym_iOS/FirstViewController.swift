...
class FirstViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if (flag==0){
            ...
            //on clean start of the app, clear data to ensure no obsolete cached copies of the website are loaded
            clearBrowsingData()
        
            //call the function that creates the shared configuration object for all the webviews
            initConfig();
