      ...
      <div class="container">
          ...
          <form class="form" id="edit-product<?php echo $row["id"]; ?>" method="POST">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="subject" name="picture" value="<?php echo $row["img_file"]; ?>" tabindex="3">
              </div>                             
             
              <div class="text-center">
                  <button type="submit" value="<?php echo $row["id"]; ?>" onclick="update(this.value)" id="edited-product" name="submit" class="btn btn-start-order">SAVE</button>
              </div>
          </form>
      </div>
  </div>
